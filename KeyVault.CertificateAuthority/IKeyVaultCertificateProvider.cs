...
namespace KeyVault.CertificateAuthority
{
    ...
    {
        Task CreateCertificateAsync(string issuerCertificateName, string certificateName, string subject, int durationDays, string[] san);
        Task CreateCACertificateAsync(string certificateName, string subject, int durationDays, string[] san, int certPathLength = 1);
